...
import static rmagalhaes.com.br.filmesfamosos.data.MoviesContract.MoviesEntry.TABLE_NAME;
...
public class MoviesContentProvider extends ContentProvider {
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        String convention = "/#";
        String path = MoviesContract.PATH_MOVIES + convention;

        uriMatcher.addURI(MoviesContract.AUTHORITY, MoviesContract.PATH_MOVIES, MOVIES);
        uriMatcher.addURI(MoviesContract.AUTHORITY, path, MOVIES_WITH_ID);
